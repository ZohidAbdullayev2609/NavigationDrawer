...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        myAdapter.list = list
        binding.rvMsjidlar.adapter = myAdapter

        myAdapter.setClickListener {
            findNavController().navigate(
                HomeFragmentDirections.actionNavHomeToSecondFragment(it)
            )
        }
